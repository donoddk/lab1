...
public class Graph
{
    ...
    private Vector<int[]> uvtemp = new Vector<int[]>();//���ڼ�¼dijsktra��dist(v)-dist(u) = c(u,v)�ı� 
    public int[] lengths;
  ...
  public  void show_path_all(String[] paths,JFrame f)
  {
    ...
    public void showTheGraphByConsole(){
        if( n == 0 ) System.out.println("��ǰ�ڽӱ�Ϊ�գ�");
        else{
    ...
    private String DFSByEdge(int sourceNode,boolean[][] isEdgeVisited){//��Ϊ����������У��������ֻ�����һ�����ѣ���������жϾ�������Ϊ�����ǿ��Ե�
        ...
        for(int i=0;i<n;i++)
            if (isEdgeVisited[sourceNode][i]==true)
                chooseEnable.add(i);
        if (chooseEnable.isEmpty()) return "";//���ýڵ㲻���г��ߣ���ʵ��ÿ�η���һ���߽�����жϾ�����ɾȥ������������ݹ����������һ����
